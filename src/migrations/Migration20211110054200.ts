...
export class Migration20211110054200 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "disc" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "brand" varchar(255) not null, "category" varchar(255) not null, "speed" varchar(255) not null, "glide" varchar(255) not null, "turn" varchar(255) not null, "fade" varchar(255) not null, "stability" varchar(255) null, "link" varchar(255) null, "pic" varchar(255) null);');
